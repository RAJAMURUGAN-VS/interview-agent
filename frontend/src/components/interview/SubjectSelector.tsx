      ...
      <main className="flex-1 lg:w-4/5 flex flex-col bg-black">
        ...
        <div className="flex-1 p-4 lg:p-8 overflow-y-auto">
          <div className="h-full flex flex-col items-center justify-center text-center py-8">
            <div className="w-28 h-28 lg:w-36 lg:h-36 bg-gradient-to-br from-zinc-800/50 to-zinc-900/50 rounded-full flex items-center justify-center mb-6 border border-zinc-700/30 shadow-[0_0_30px_rgba(102,126,234,0.2)]">
              <i className="fas fa-microphone text-4xl lg:text-5xl text-zinc-400" />
            </div>
            <h2 className="font-space text-2xl lg:text-3xl font-bold bg-gradient-to-r from-[#667eea] to-[#764ba2] bg-clip-text text-transparent mb-3">
              Ready to Practice?
            </h2>
            <p className="text-gray-400 text-base lg:text-lg">Select a topic from the sidebar to begin</p>
          </div>
        </div>
      </main>
    </>
